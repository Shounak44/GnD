...
@export var fade_anim_name: String = "fade5"

# Dialogue sequence — panel names must match the Panel nodes under CanvasLayer
var dialogue_sequence := [
	{"speaker":"BoxPanel", "text":"In the afternoon, Mina went for a walk and met a farmer."},
	{"speaker":"MinaPanel", "text":"Hello...why are you sitting here alone ? you look very sad."},
	{"speaker":"FarmerPanel", "text":"My fields is now fallow and I can't afford irrigation system...I don't even know what my kids will eat tommorow."},
	{"speaker":"BoxPanel", "text":"Mina felt very sad and went back home."}
]
...
func _ready() -> void:
	...
	var panels = ["BoxPanel","MinaPanel","FarmerPanel"]
	for p in panels:
	...
	if event.is_action_pressed("ui_accept"):
		if is_typing:
			...
			if current_index < dialogue_sequence.size():
				...
				# sequence finished — go to next scene (change path if needed)
				get_tree().change_scene_to_file("res://Scenes/story_6_5.tscn")
...
func _hide_all_panels() -> void:
	for n in ["BoxPanel","MinaPanel","FarmerPanel"]:
