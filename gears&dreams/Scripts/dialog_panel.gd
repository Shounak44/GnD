...
var dialogues := [
	"Yayy, I'm finally going to India",
	"We'll go to Rajasthan first, Mom told me there are big deserts and camels",
	"I really want to see a REAL camel",
	"Speaking of camels, I should finish this puzzle"
]
	...
	if event.is_action_pressed("ui_accept"):
		if is_typing:
			...
			if current_index < dialogues.size() - 1:
				...
				ScreenLoader.load_scene("res://Scenes/game_1.tscn")
